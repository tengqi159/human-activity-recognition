...
def train(EPOCH,train_loader, test_x_path, test_y_path,train_error,test_error):
    ...
    for step, (batch_x, batch_y) in enumerate(train_loader):
        ...
        # if step==10:
        #     print(batch_x,'22222222222222222222222222222222222222222222222222222222222222')
    ...
    # string_print = 'Train epoch={},   loss_global={:.4f}, mem={:.0f}MiB, max_mem={:.0f}MiB\n'.format(
    #     epoch,
    #     loss_average_global,
...
if __name__ == '__main__':
    ...
    # train_loader2 = load_data(pathlist[0], pathlist[1], batchsize=400)
...
#         loss_pred = (1 - 1) * F.cross_entropy(y_hat_local, y.detach().long())
#
#         Ry = similarity_matrix(y_onehot).detach()
#         loss_sim = 1* F.mse_loss(Rh, Ry)
#
...
#
#         np.save('./matplotlib_picture/UCI_error/sim_train.npy', train_error)
#     #
#     # if epoch % 1 == 0:
#     #     model.eval()
#     #
...
#     #     reca = recall_score(test_y_onehot.cpu().numpy(), test_output_f1, average='weighted')
#     #     label = [0,1, 2, 3, 4, 5]
#     #     # confu=confusion_matrix(test_y.cpu().numpy(), test_output,labels=label)
#     #     # print(confusion_y.tolist(), '\n', test_output_f1_con.tolist())
...
#     #     # print(test_output.shape,'test_output.shape')
#     #     accuracy = (torch.sum(test_output == test_y.long()).type(torch.FloatTensor) / test_y.size(0)).cuda()
#     #     # confu = confusion_matrix(test_y.cpu().numpy(), test_output.cpu(),labels=label)
...
#     #     #     pass
#     #     model.train()
#     # # plt.savefig('./confu.jpg')
#     #
#     # #
#     # # np.save('./accuracy.npy',accuracy_list)
#     # # np.save('./matplotlib_picture/alpha_dynamical/alpha-1.00.npy',test_error)
#
# if __name__ == '__main__':
#
...
#         test_error=[]
#         accuracy_list=[]
#         lr=[0.004,0.001,0.0009,0.0007,0.0007]
